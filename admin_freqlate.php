...
<br>
  <div class="container-fluid">
    <ul class="nav nav-tabs">
               <li class="nav-item">
                 <a class="nav-link" href="admin_report.php">Records</a>
               </li>
               <li class="nav-item">
                 <a class="nav-link active" href="admin_freqlate.php">Frequent Late</a>
               </li>
               <li class="nav-item">
        ...
        <tbody>
           <?php  
            $currMonth = date("F");
            $query ="SELECT id, email, schoolyear, semester, dateMonth, COUNT(time_in) AS late FROM
                  tbl_records
                  WHERE dateMonth = '$currMonth' AND time_in = 'LATE' GROUP BY email HAVING late >= 2";  
