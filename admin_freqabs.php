...
<br>
  <div class="container-fluid">
    <ul class="nav nav-tabs">
               ...
               <li class="nav-item">
                 <a class="nav-link active" href="admin_freqabs.php">Frequent Absent</a>
               </li>
             </ul>
        ...
        <tbody>
           <?php  
           $currMonth = date("F");
            $query ="SELECT id, email, schoolyear, semester, dateMonth, COUNT(time_in) AS absent FROM
                  tbl_records
                  WHERE dateMonth = '$currMonth' AND time_in = 'ABSENT' GROUP BY email HAVING absent >= 5";  
