         ...
         <a href="#"><!-- a href begin -->
          <form method="post">
                <div class="panel-footer"><!-- panel-footer begin -->
                  ...
                  <input type="submit" class="btn btn-info" id="search" name="Search4" value="Search">
                </div><!-- panel-footer finish -->
              </form>
            </a><!-- a href finish -->
      </div> 
...
<?php 
    ...
    if (isset($_POST["Search4"])){
      include 'open_db.php';
      $selecttxt4 = $_POST["Fromdate4"];
      $queryres = mysqli_query($con,"SELECT * FROM tbl_users INNER JOIN tbl_records ON tbl_records.users_id=tbl_users.id WHERE dateToday = '$selecttxt4' AND time_in = 'ONLEAVE'");

       $queryres = "SELECT * FROM tbl_users INNER JOIN tbl_records ON tbl_records.users_id=tbl_users.id WHERE CONCAT(dateToday) LIKE '%".$selecttxt4."%' AND time_in = 'ONLEAVE'";
      $search_result = filterTable($queryres);
    }
    else{

       $currentDate = date("d-m-Y");
       $queryres = "SELECT * FROM tbl_users INNER JOIN tbl_records ON tbl_records.users_id=tbl_users.id WHERE dateToday = '$currentDate' AND time_in = 'ONLEAVE'";
       $search_result = filterTable($queryres);
               ...
               <li class="nav-item">
                 <a class="nav-link active" href="admin_onleave.php">On-Leave</a>
               </li>
             </ul>
