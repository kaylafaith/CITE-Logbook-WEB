          ...
          <form method="post">
                <div class="panel-footer">
                  <!-- panel-footer begin -->
                   ...
                   <input type="submit" class="btn btn-info" id="search" name="Search3" value="Search">
                </div><!-- panel-footer finish -->
              </form>
            </a><!-- a href finish -->
      </div>
...
<?php 
    ...
    if (isset($_POST["Search3"])){
      include 'open_db.php';
      $selecttxt3 = $_POST["Fromdate3"];
      $queryres = mysqli_query($con,"SELECT * FROM tbl_users INNER JOIN tbl_records ON tbl_records.users_id=tbl_users.id WHERE dateToday = '$selecttxt3' AND time_in = 'ABSENT'");

       $queryres = "SELECT * FROM tbl_users INNER JOIN tbl_records ON tbl_records.users_id=tbl_users.id WHERE CONCAT(dateToday) LIKE '%".$selecttxt3."%' AND time_in = 'ABSENT'";
      $search_result = filterTable($queryres);
    }
    else{

       $currentDate = date("d-m-Y");
       $queryres = "SELECT * FROM tbl_users INNER JOIN tbl_records ON tbl_records.users_id=tbl_users.id WHERE dateToday = '$currentDate' AND time_in = 'ABSENT'";
       $search_result = filterTable($queryres);
               ...
               <li class="nav-item">
                 <a class="nav-link active" href="admin_absent.php">Absent</a>
               </li>
               <li class="nav-item">
